      ...
      <section class="ms_form_long" @click.stop>
              ...
              <form @submit="sub" id="formadd" name="formadd">
                  ...
                  <div class="price">
                    <div>
                  <label for="">價格 : </label>
                  <input type="text" class="ms_input" name="ppr">
                </div><div>
                  <label for="">庫存 : </label>
                  <input type="number" class="ms_input" name="pstock">
                </div>
                  </div>
                  </div>
                  <div class="select">
                  ...
                  <label for="file-main">商品主圖 : {{ form.img1name }}
                  <input type="file" id="file-main" class="op0" name="pimg1" @change="fileup($event,'img1')">
                  </label>
                  
                  <label for="file-one">商品圖片一 : <br><span>{{ form.img2name }}</span>
                  <input type="file" id="file-one" class="op0" name="pimg2" @change="fileup($event,'img2')">
                  </label>
                 
                  <label for="file-two">商品圖片二 : <br><span>{{ form.img3name }}</span>
                  <input type="file" id="file-two" class="op0" name="pimg3" @change="fileup($event,'img3')">
                  </label>
                 
                  <label for="file-three">商品圖片三 : <br><span>{{ form.img4name }}</span>
                  <input type="file" id="file-three" class="op0" name="pimg4" @change="fileup($event,'img4')">
                  </label>
  ...
  //   };
    ...
    select:nth-child(2){
      ...
      div.file{
          ...
          label:nth-child(2),label:nth-child(3),label:nth-child(4){
            // outline: 1px solid red;
          text-align: left;
          height: 70px; 
          }
